...
{/* MARCA */}
<p className="mt-4 text-sm font-semibold tracking-[0.2em] text-gray-400 text-center uppercase">
  {item.marca || "SIN MARCA"}
</p>

{/* NOMBRE */}
<h3 className="font-bold text-lg mt-2 min-h-[60px] text-center text-gray-900">
  {item.nombre}
</h3>
...
{item.oferta ? (
  ...
  <p className="text-green-600 text-2xl font-bold mt-3 text-center">
    S/ {Number(item.precio || 0).toFixed(2)}
  </p>
)}
